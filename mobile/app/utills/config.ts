...
//    often contains your machine IP (e.g. "192.168.15.72:19000"). We prefer that.
...
//    your machine's LAN IP (e.g. "192.168.15.72") or use a tunnel (ngrok) and point
...
// Example for a physical device: const MANUAL_HOST = "192.168.15.72";
...
const MANUAL_HOST: string | null = "https://kaamwalibai.onrender.com";
