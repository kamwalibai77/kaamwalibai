  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <Ionicons name="people-circle-outline" size={40} color="white" />
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          At <Text style={styles.bold}>Kamwali Bai</Text>, we believe that every
          household deserves reliable and professional home support. We are
          building a platform dedicated to connecting people with skilled and
          trustworthy home maids across India.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>👨‍💻 Mohit Pote – Team Lead, Development</Text>
        <Text style={styles.text}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          Trimurti Nagar, Nagpur, Maharashtra – 440022
        </Text>
      </View>
    </ScrollView>
  );
